...
GO
PRINT N'Creando Procedimiento [dbo].[VerProductosBodega]...';


GO
CREATE PROCEDURE [dbo].[VerProductosBodega]
	@codProd int 
AS
	SELECT cantidad_bodega, seccion_bodega FROM LugarStock Where Id_lugar = @codProd
RETURN 0
GO
