...
CREATE PROCEDURE [dbo].[MoverAgondola]
	...
	@n int
AS
	UPDATE LugarStock SET cantidad_bodega = cantidad_bodega -@n, cantidad_bodega= cantidad_bodega +@n, cantidad_gondola = cantidad_gondola +@n, cantidad_gondola= cantidad_gondola -@n WHERE barcode_producto = @codigo 
RETURN 0
